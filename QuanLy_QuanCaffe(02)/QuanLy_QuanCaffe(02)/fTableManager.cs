...
using static QuanLy_QuanCaffe_02_.fAcountProfile;
...
namespace QuanLyQuanCafe
{
    public partial class fTableManager : Form
    {
        ...
        {
            lsvBill.Items.Clear();
            List<QuanLy_QuanCaffe_02_.DTO.Menu> listBillInfo = MenuDAO.Instance.GetListMenuByTable(id);
            float totalPrice = 0;
            foreach(QuanLy_QuanCaffe_02_.DTO.Menu item in listBillInfo)
            {
